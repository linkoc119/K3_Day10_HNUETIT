...
| **Khóa/Lớp** | K3 VinUni |
| **Tên nhóm** | Group 3 |
| **Vai trò chính** | Pipeline Orchestrator & Experiment Lead |
...
Xây dựng và đảm bảo tính tin cậy của tầng dữ liệu/mô hình thuộc vai trò **Pipeline Orchestrator & Experiment Lead**, giúp pipeline chuyển đổi dữ liệu thông suốt và chính xác từ nguồn thô Crossref đến câu trả lời RAG cuối cùng.
...
- **Artifact/log:** các tệp tin lưu tại `src/pipelines/, script/`.
