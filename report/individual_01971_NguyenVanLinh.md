...
### Cách triển khai
Xây dựng bộ câu hỏi 10 mẫu dạng factual, viết QA Agent trích xuất câu trả lời thông minh dựa trên từ khóa tiếng Việt/Anh và exact title lookup. Tính điểm Token F1 overlap và LLM Judge evaluation.
...
- **Lý do:** Tăng điểm Token F1 từ 0.04 lên 0.9087 và Judge Accuracy đạt 100.00%.
